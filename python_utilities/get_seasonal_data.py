...
def add_params(root_grp):
    ...
    g_m_conc = root_grp.createVariable('goddard_merged_seaice_conc_monthly', 'f8', ('time','ygrid','xgrid'))
    m_o_day = root_grp.createVariable('melt_onset_day_seaice_conc_monthly_cdr', 'f8', ('time','ygrid','xgrid'))
